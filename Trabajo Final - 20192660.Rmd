...
Previamente, a partir de un anñalisis de gráfico de la silueta, se determinó que el método de partición era el más adecuado para clusterizar y dividir nuestros datos en grupos.
...
Ahora verificamos a cuál le fue mejor mediante el **cálculo de la silueta**
